...
public class Receipt<T extends Number> {
    ...
    public Double summaPoMarshrutu() {
        ...
        Double doplata057 = tarif * 0.04;
        summ =  tarif + doplata025 + doplata151 + doplata152 + bonus011 + doplata057;
        return summ;
    }
    ...
    public String toString() {
        ...
        sb.append(", harmfulWorkingConditions057=").append(harmfulWorkingConditions057);
