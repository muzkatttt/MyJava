...
public class Main {
    public static void main(String[] args) {
        ...
        // создание списка учителей по аналогии со списком студентов как на семинаре
        /*
        TeacherGroup teachers = new TeacherGroup(List.of(new Teacher(10001, "Василиса",
                        "Премудрая", "Ивановна", LocalDate.of(1970, 10, 11)),
                new Teacher(10005, "Белоснежка", "Семигномова",
                        "Петровна", LocalDate.of(1974, 12, 24)),
                new Teacher(10003, "Забава", "Попова",
                        "Царевна", LocalDate.of(1972, 3, 23))));
